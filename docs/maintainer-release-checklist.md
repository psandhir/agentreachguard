...
- Build the wheel and source distribution, install the wheel in a clean environment, and run `agentreachguard --help`, `agentreachguard rules --format json`, and a secure fixture scan.
