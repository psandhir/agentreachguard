...
- Rename the open-source project from **AgentReachGuard** to **HorusTrace** and migrate the primary PyPI distribution, Python package, CLI, and configuration names to `horustrace` while retaining compatibility aliases.
