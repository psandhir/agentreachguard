...
The corpus contains 25 reviewed scenarios across secure agents, execution, delegation, MCP, identity, data/network, attack paths, and false-positive traps. The corpus has an `.agentreachguard-ignore` marker, so intentionally vulnerable
